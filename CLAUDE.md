...
- **`subagent-delegation`** — delegate only when asked, pick the model per task (cheap for mechanical work, strong for judgement), and verify every result before using or reporting it
